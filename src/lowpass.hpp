...
#pragma mark > Constructors & Destructors
         ...
         */
        LowpassFilter(double cutoff = 1.,
                      int order = 4,
                      double rippleLevel = 0.05);
...
#pragma mark === Protected Methods ===
         ...
         */
        double cheby1ap(int filter_order, double ripple_db, std::vector< std::complex<double> > &p);
         ...
         * @return System gain of the analog IIR filter transfer function.
         */
        double _zpklp2lp(std::vector< std::complex<double> > &p, double k, double wo);
        
        /**
         * @brief Estimates digital filter from an analog one using a bilinear transform.
         * @param z Zeros of the analog IIR filter transfer function.
         * @param p Poles of the analog IIR filter transfer function.
         * @param k System gain of the analog IIR filter transfer function.
         * @return System gain of the analog IIR filter transfer function.
         */
        double _zpkbilinear(std::vector< std::complex<double> > &z, std::vector< std::complex<double> > &p, double k);
         ...
         * @param k System gain of the analog IIR filter transfer function.
         */
        void zpk2tf(std::vector< std::complex<double> > &z, std::vector< std::complex<double> > &p, double k);
