...
// analyze
Rcpp::List analyze(std::vector<double> x, float bands_per_octave, float frequency_min, float frequency_max, float samplerate_hz, std::string mother_wavelet, float morlet_carrier, unsigned int paul_order, std::string optimisation);
RcppExport SEXP _RcppWavelet_analyze(SEXP xSEXP, SEXP bands_per_octaveSEXP, SEXP frequency_minSEXP, SEXP frequency_maxSEXP, SEXP samplerate_hzSEXP, SEXP mother_waveletSEXP, SEXP morlet_carrierSEXP, SEXP paul_orderSEXP, SEXP optimisationSEXP) {
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(analyze(x, bands_per_octave, frequency_min, frequency_max, samplerate_hz, mother_wavelet, morlet_carrier, paul_order, optimisation));
    return rcpp_result_gen;
END_RCPP
}
// analyzeParallel
Rcpp::List analyzeParallel(std::vector<double> x, float bands_per_octave, float frequency_min, float frequency_max, float samplerate_hz, int cores, std::string mother_wavelet, float morlet_carrier, unsigned int paul_order, std::string optimisation);
RcppExport SEXP _RcppWavelet_analyzeParallel(SEXP xSEXP, SEXP bands_per_octaveSEXP, SEXP frequency_minSEXP, SEXP frequency_maxSEXP, SEXP samplerate_hzSEXP, SEXP coresSEXP, SEXP mother_waveletSEXP, SEXP morlet_carrierSEXP, SEXP paul_orderSEXP, SEXP optimisationSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< std::vector<double> >::type x(xSEXP);
    ...
    Rcpp::traits::input_parameter< unsigned int >::type paul_order(paul_orderSEXP);
    Rcpp::traits::input_parameter< std::string >::type optimisation(optimisationSEXP);
    rcpp_result_gen = Rcpp::wrap(analyzeParallel(x, bands_per_octave, frequency_min, frequency_max, samplerate_hz, cores, mother_wavelet, morlet_carrier, paul_order, optimisation));
    return rcpp_result_gen;
END_RCPP
}
// getScales
...
static const R_CallMethodDef CallEntries[] = {
    {"_RcppWavelet_analyze", (DL_FUNC) &_RcppWavelet_analyze, 9},
    {"_RcppWavelet_analyzeParallel", (DL_FUNC) &_RcppWavelet_analyzeParallel, 10},
